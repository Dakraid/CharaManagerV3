...
--> statement-breakpoint
CREATE
    OR REPLACE FUNCTION HASH_CONTENT(CONTENT TEXT) RETURNS TEXT AS
$$
DECLARE
    output TEXT;
BEGIN
...
$$
    LANGUAGE PLPGSQL;
--> statement-breakpoint
CREATE OR REPLACE FUNCTION get_tags_from_definitions()
    RETURNS TABLE
            (
                tag text
            )
...
BEGIN
    RETURN QUERY
        SELECT DISTINCT UPPER(t.tag)
        FROM definitions d
                 CROSS JOIN LATERAL jsonb_array_elements_text(
                CASE
                    WHEN jsonb_typeof(d.content -> 'data' -> 'tags') = 'array'
                        THEN d.content -> 'data' -> 'tags'
                    ELSE '[]'::jsonb
                    END
                                    ) AS t(tag);
END;
...
ALTER TABLE "characters"
    ADD CONSTRAINT "characters_ownerid_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."users" ("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "definitions"
    ADD CONSTRAINT "definitions_characterid_fkey" FOREIGN KEY ("character_id") REFERENCES "public"."characters" ("character_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "evaluations"
    ADD CONSTRAINT "evaluations_definitionid_fkey" FOREIGN KEY ("definition_id") REFERENCES "public"."definitions" ("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "originals"
    ADD CONSTRAINT "originals_characterid_fkey" FOREIGN KEY ("character_id") REFERENCES "public"."characters" ("character_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "relationships"
    ADD CONSTRAINT "relationships_parentid_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."characters" ("character_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "relationships"
    ADD CONSTRAINT "relationships_childid_fkey" FOREIGN KEY ("child_id") REFERENCES "public"."characters" ("character_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
