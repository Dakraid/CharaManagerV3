	...
	<DropdownMenu>
		...
		<DropdownMenuContent align="end">
			...
			<DropdownMenuLabel class="flex w-full grow flex-col gap-2">
				...
				<Button class="flex cursor-pointer justify-between gap-2" :variant="colorMode.preference === 'light' ? 'default' : 'outline'" @click="colorMode.preference = 'light'">
				...
				<Button class="flex cursor-pointer justify-between gap-2" :variant="colorMode.preference === 'dark' ? 'default' : 'outline'" @click="colorMode.preference = 'dark'">
				...
				<Button class="flex cursor-pointer justify-between gap-2" :variant="colorMode.preference === 'system' ? 'default' : 'outline'" @click="colorMode.preference = 'system'">
			...
			<DropdownMenuLabel class="flex w-full grow flex-col gap-2">
				...
				<div class="items-top flex w-full max-w-sm gap-2">
					<Checkbox
						...
						@update:model-value="
							(value) => {
								settingsStore.permaControls = value == true;
							}
						" />
			...
			<DropdownMenuLabel class="flex w-full grow flex-col gap-2">
				...
				<div class="items-top flex w-full max-w-sm gap-2">
					<Checkbox
						...
						" />
					<div class="grid gap-2 leading-none">
						<label for="censorNames" class="cursor-pointer text-center text-sm leading-none font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
